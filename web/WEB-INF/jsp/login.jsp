...
<head>
    ...
    <script type="text/javascript" src="/online/js/checknumber.js"></script>
...
<div class="container demo-1">
    <div class="content">
        <div id="large-header" class="large-header">
            ...
            <form class="form" onSubmit="return false" autocomplete="off" action="/user/testLogin"
...
<%--                    </div>--%>
                    <div class="btn-group">
                        <input  class="btn btn--primary" value="登录" onclick="window.location.href='${pageContext.request.contextPath}/user/testLogin?username=${username}&password=${password}'" id="pp">
                        <button class="btn btn--primary" onclick="window.location.href = '/user/register'">注册</button>
                        <button class="btn btn--primary" onclick="window.location.href = '/user/forget'">忘记密码</button>
                    </div>
                </div>
</form>
        </div>
...
<script src="/online/js/TweenLite.min.js"></script>
<script src="/online/js/EasePack.min.js"></script>
<script src="/online/js/demo-1.js"></script>
</body>
</html>